...
public class ChunkGeneratorCallable implements
	Callable<Map<Vector3i, BlockData>>
{
    ...
    public ChunkGeneratorCallable(Vector3i location, int planetDiameter,
	    int chunkSize, PlanetType planetType, long planetSeed)
    {
    ...
    private void setBlocksFromNoise(Vector3i size, GameBlock blockClass,
	    PlanetFace face)
    {
	...
	rmft.setScale(1.f / 64.f);
	BasicNoise ridgedMF = new BasicNoise(rmft, 0.5f, 0.086f,
		(int) planetSeed, 2, 3.02f, 1.5f, true, basis);
	Transform simt = new Transform();
	simt.setScale(1.f / 64.f);
