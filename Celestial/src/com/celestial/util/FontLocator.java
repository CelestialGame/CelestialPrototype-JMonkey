 ...
 *
 * String format: font(size):font_resource_name
 * font(size,color):font_resource_name font(size,color,style):font_resource_name
 *
 ...
 * <code>assetManager.registerLocator("", FontLocator.class);</code> Don’t
 * forget to register the TTF FontLoader:
...
public class FontLocator implements AssetLocator
{
	...
	else
	{
	    ...
	    FontKey newkey = new FontKey(name, Font.TRUETYPE_FONT, color, size,
		    style);
