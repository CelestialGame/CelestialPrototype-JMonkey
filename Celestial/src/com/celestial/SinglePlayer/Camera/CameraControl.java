 ...
 * Camera tid bits
 *
 * @author kevint. Created Dec 1, 2013.
 */
public class CameraControl {
	...
	public void updateCamera(float tpf) {
		if (this.parent.player.getBulletAppState().isEnabled()) {
			...
			// this.parent.player.getLocalForward());
			...
			this.cam.setLocation(new Vector3f(this.parent.player.getLocation().getX(),
					this.parent.player.getLocation().getY(), this.parent.player.getLocation().getZ()));
		}
