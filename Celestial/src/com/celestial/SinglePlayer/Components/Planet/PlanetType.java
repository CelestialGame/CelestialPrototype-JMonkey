...
public enum PlanetType
{
    ...
    public static final EnumSet<PlanetType> PLANETTYPES = EnumSet.range(
	    HABITABLE, FRIGID);
    public static final EnumSet<PlanetType> HOSTILETYPES = EnumSet.range(INNER,
	    MOON);
    public static final EnumSet<PlanetType> ATMOSPHERETYPES = EnumSet.range(
	    HABITABLE, OUTER);
    ...
    public static final EnumSet<PlanetType> ALLTYPES = EnumSet
	    .allOf(PlanetType.class);
