...
public class Galaxy
{
     ...
     * @param diameter
     *            The diameter of the galaxy (in sectors) MUST be odd number
     * @param depth
     *            The depth of the galaxy (in sectors) MUST be odd number
     * @param maxSystemsPerSector
     *            The maximum amount of systems per sector
     */
    public Galaxy(CelestialPortal portal, int diameter, int depth,
	...
	for(int i = 0; i < diameter; i++)
	{
		...
		for(int k = 0; k < depth; k++)
		{
		    ...
		    this.createSectorAt(i - (this.centerOfDiameter - 1), j
			    - (this.centerOfDiameter - 1), k
			    - (this.centerOfDepth - 1), "Alpha");
		}
	    }
	}
    }
