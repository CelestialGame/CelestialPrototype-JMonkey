...
public class SolarSystem {
	...
	private void generate() {
		...
		Planet p = new Planet(star, 15, new Vector3f(3000, -500, 3000), name + " III");

		Planet p1 = new Planet(star, 3, new Vector3f(1000, 0, 1000), name + " I");
		Planet p2 = new Planet(star, 3, new Vector3f(1000, 0, 2500), name + " II");
		Planet p3 = new Planet(star, 3, new Vector3f(1000, 0, 5000), name + " IV");
