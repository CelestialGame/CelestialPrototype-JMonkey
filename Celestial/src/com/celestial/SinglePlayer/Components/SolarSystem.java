...
public class SolarSystem
{
	 ...
	 * " I"); Planet p2 = new Planet(star, 1, new Vector3f(1000, 0, 2500),
	 * name + " II"); Planet p3 = new Planet(star, 1, new Vector3f(1000, 0,
	 * 5000), name + " IV");
	 */
	...
	/*
	 * this.planetList.add(p1); this.planetList.add(p2);
