...
public class Celestial extends SimpleApplication {
	...
	public static void main(String[] args) {
		...
		Celestial.width = (850 * 2);
		Celestial.height = (500 * 2);
	...
	public void simpleInitApp() {
		...
		gui = new Gui(this, assetManager, inputManager, audioRenderer, guiViewPort, flyCam);
	}

	public void startGame(int type) {
		if (type == Celestial.SINGLEPLAYER) {

			Celestial.portal = new SPPortal(this, rootNode, guiNode, cam, flyCam, viewPort, assetManager, inputManager,
					settings, app, timer, gui);
		} else {
